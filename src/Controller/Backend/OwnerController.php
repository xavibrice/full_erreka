...
class OwnerController extends AbstractController
{
    ...
    {
        return $this->render('backend/owner/index.html.twig', [
    ...
    public function new(Request $request): Response
    {
        ...
        return $this->render('backend/owner/new.html.twig', [
            'owner' => $owner,
    ...
    {
        return $this->render('backend/owner/show.html.twig', [
            'owner' => $owner,
        ]);
    }
    ...
    public function edit(Request $request, Owner $owner): Response
    {
        ...
        return $this->render('backend/owner/edit.html.twig', [
            'owner' => $owner,
            'form' => $form->createView(),
        ]);
    }
