...
class AgentController extends AbstractController
{
    ...
    {
        return $this->render('backend/agent/index.html.twig', [
    ...
    public function new(Request $request): Response
    {
        ...
        return $this->render('backend/agent/new.html.twig', [
            'agent' => $agent,
    ...
    {
        return $this->render('backend/agent/show.html.twig', [
            'agent' => $agent,
        ]);
    }
    ...
    public function edit(Request $request, Agent $agent): Response
    {
        ...
        return $this->render('backend/agent/edit.html.twig', [
            'agent' => $agent,
            'form' => $form->createView(),
        ]);
    }
